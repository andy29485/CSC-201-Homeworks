 ...
 *     employee has an office, salary, and date hired. Use the MyDate class
 ...
 *     the person’s name. Draw the UML diagram for the classes and implement
 *     them. Write a test program that creates a Person, Student, Employee,
 ...
 *
 * Pseudocode:
 *   1. gets and set nothing intresting
 */
...
class Person {
  ...
  public Person(String strName,         String strStreetAddress,
                String strEmailAddress, int    nPhoneNumber) {
    this.strName          = strName;
