...
/* Description:
 *   Write a program that displays the defining characteristics of the
 *     computer in a format that would attract potential users. Continue your
 *     exercise by simulating an upgrade for the computer chosen earlier. Choose
 *     a better processor, more RAM, a different hard disk drive, an audio card,
 *     a video card, and speakers. Find prices for all the components mentioned
 *     above. Continue your program, defining appropriate variables for the new
 *     components, and the price of the new, upgraded computer. Read all prices
 *     from the user, and calculate the price of the new computer. Display the
 *     new configuration, with all the characteristics defined earlier, as well
 *     as the price.
 * Assumptions:
 *   - Original computer is a list of part names and prices, hardcoded
 *   - Original computer price is the sum of all the components
 *   - User will enter new part names and prices, inputted
 *   - Both the total price of the original computer and user created computer
 *       will be displayed
 *   - User MUST enter a new name and price for each of the components
 *     - however, the new name/price, can be an exact match of the old one
 *   - All prices are in USD
 * Pseudocode:
 *   1. declare prices as doubles
 *   2. declare names as string
 *   3. print the components, match strings to doubles
 *   4. print total price, add all doubles together
 *   5. input new names/prices from user
 *   6. print the components, match strings to doubles
 *   7. print total price, add all doubles together
 */
